...
%
<<figscatterindepfilt, results='hide'>>=
with(res,
...
%
<<badfilter1,cache=TRUE, results='hide'>>=
...
%
<<figrejection,fig.width=5.5,fig.height=5.5, results='hide'>>=
...
<<figdifferentstats,fig.width=5.5,fig.height=5.5, results='hide'>>=
